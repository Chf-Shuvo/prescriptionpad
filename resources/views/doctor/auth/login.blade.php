  ...
  <div class="login-header box-shadow">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <div class="login-menu">
        <a href="{{ route('admin.login') }}"> Login as Admin</a> || <a href="{{ route('pharmacy.login') }}"> Pharmacy</a> || <a href="{{ route('login') }}"> Patient</a>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-6 col-lg-7">
          <img src="{{ asset('backend/src/images/doctor_login_page.png') }}" alt="" />
        </div>
    ...
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-body">
          <form action="{{ route('send.password.reset.link', 'doctor') }}" method="post">
            @csrf
            <div class="form-row">

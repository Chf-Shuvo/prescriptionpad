                        ...
                        <tbody>
                          <tr>
                            <td style="width:64px;">
                              ...
                              <img height="auto" src="https://img.icons8.com/ios/50/null/security-shield-green.png" style="border:0;display:block;outline:none;text-decoration:none;width:100%;"
                                width="64" />
                        ...
                        <tr>
                          <td align="center" bgcolor="#2F67F6" role="presentation" style="border:none;border-radius:3px;color:#ffffff;cursor:auto;padding:15px 25px;" valign="middle">
                            <p
                              ...
                              <a href="{{ route('password.reset.set', [$details['user_type'], encrypt($details['email'])]) }}" target="_blank">Click on this link to reset your passsowrd</a>
                            </p>
                          </td>
                        </tr>
                      </table>

    ...
    <div class="row pd-20">
      <div class="col-lg-12 col-md-12 col-sm-12 text-right">
        ...
        <button type="button" class="btn btn-primary btn-lg m-3" data-toggle="modal" data-target="#modelId">
          <i class="icon-copy dw dw-add"></i> add pharmacy
        </button>
      </div>
          ...
          <tbody>
            @foreach ($pharmacies as $item)
              <tr>
                ...
                <td>{{ $item->email }}</td>
                <td>
                  <a href="{{ route('admin.pharmacy.edit', $item->id) }}" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="edit-pharmacy"><i
                      class="icon-copy dw dw-edit-1"></i></a>
                  <a href="{{ route('admin.pharmacy.destroy', $item->id) }}" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="delete-pharmacy"
                    onclick="return confirm('Are you sure to delete this pharmacy?')"><i class="icon-copy dw dw-trash1"></i></a>
                </td>
              </tr>
            @endforeach
          </tbody>

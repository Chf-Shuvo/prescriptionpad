    ...
    <div class="row pd-20">
      <div class="col-lg-12 col-md-12 col-sm-12 text-right">
        ...
        <button type="button" class="btn btn-primary btn-lg m-3" data-toggle="modal" data-target="#modelId">
          <i class="icon-copy dw dw-add"></i> add admin
        </button>
      </div>
          ...
          <tbody>
            @foreach ($admins as $item)
              <tr>
                ...
                <td>{{ $item->email }}</td>
                <td>
                  <a href="{{ route('admin.manage.edit', $item->id) }}" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="edit-admin"><i
                      class="icon-copy dw dw-edit-1"></i></a>
                  <a href="{{ route('admin.manage.destroy', $item->id) }}" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="delete-admin"
